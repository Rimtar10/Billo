...
export default function Send({ navigation, route }) {
  ...
  // Sender info
  const [senderName] = useState("Nataly Fakih");
  ...
  const openConfirmPopup = () => {
    if (!receiverName || !phoneNumber || !walletNumber || !amount) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.label}>Sender Full Name</Text>
          <View style={styles.disabledInput}>
            <Text style={styles.disabledInputText}>{senderName}</Text>
          </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.label}>Receiver's Wallet/Account Number*</Text>
          <TextInput
            style={styles.input}
            value={walletNumber}
          ...
          <Text style={styles.label}>Choose Receiving Method*</Text>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.label}>Note to Receiver</Text>
          <TextInput
          ...
          <View style={styles.feeInfoCard}>
            ...
            <View style={styles.feeRow}>
              <Text style={styles.receivedLabel}>Receiver Gets</Text>
        ...
        {/* Send Button */}
        <TouchableOpacity style={styles.sendButton} onPress={openConfirmPopup}>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.popup}>
            ...
            <Text style={styles.popupText}>
              Send {selectedCurrency} {amount} to {receiverName}?
            </Text>
...
// Styles: combine both styles objects intelligently
